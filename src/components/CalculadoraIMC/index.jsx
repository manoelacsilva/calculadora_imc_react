            ...
            <div className="calculadora">
                <div className="input-box">
                    ...
                    <div className="input-field">
                        <input className="campo" onChange={evento => {setPeso(parseFloat(evento.target.value)); handleInputChange(); }} id="weight" required />
                    </div>
                </div>
                <div className="input-box">
                    <label htmlFor="altura">Digite a sua altura (m):</label>
                    <div className="input-field">
                        <input className="campo" onChange={evento => {setAltura(parseFloat(evento.target.value)); handleInputChange(); }} id="height" required />
                    </div>
                </div>
            </div>
